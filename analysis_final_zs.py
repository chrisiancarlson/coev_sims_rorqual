...
def sliding_window_ILD(mut_dict_m,mut_dict_p,m_mut_freq_dict,p_mut_freq_dict,m_f_mut_freq_dict,p_f_mut_freq_dict): 
    ILDS=[]
    freq_ILDS=[]
    mut_ILD_dict_m={}
    # calculate ILDS: 
    ...
    for i,max in enumerate(windows): 
        ...
        for mut in keys_list: 
            ...
            if pos<max and pos>=max-delta: 
                ...
                #print(pos)
                #sys.exit()
                #mean_ILD=np.mean(mut_ILD_dict_m[mut])
                m_ILDS=mut_ILD_dict_m[mut]
                
                ILDS_in_window.append(m_ILDS)
                if mut in m_f_mut_freq_dict.keys(): freq_ILDS_in_window.append(mut_ILD_dict_m[mut])
        ...
        freq_window_dict[max]=np.mean(correlations)
...
def ILD_stats(m_space_dict,p_space_dict,mut_dict_m,mut_dict_p,moth_demes,plant_demes,s_f,sigma,rep): 
   ...
   #print(p_freq_muts)
    ...
    print('onto ILDS')
    ILDS,freq_ILDS,window_dict,freq_window_dict=sliding_window_ILD(mut_dict_m,mut_dict_p,m_mut_freq_dict,p_mut_freq_dict,m_f_mut_freq_dict,p_f_mut_freq_dict)

    print(window_dict)
    print(freq_window_dict)
